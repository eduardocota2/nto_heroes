...
local qtd_m = 150
local item_r = 11221
local xp_a =  40700 --40700, 74200, 117700
-- selfSay('Você pode dropar este item de criaturas como : X {entregar}', cid)
...
if(msgcontains(msg, 'item') or msgcontains(msg, 'items')) then
selfSay('Você pode dropar este item de criaturas como : X {entregar}', cid)
talkState[talkUser] = 1
elseif(msgcontains(msg, 'entregar') and talkState[talkUser] == 1) then
if(getPlayerStorageValue(cid, stor_a) < 1 ) then
