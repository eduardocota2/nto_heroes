local t = {
storage = 676634,  -- storage, so mude se tiver usando pra outra coisa.
...
function onUse(cid, item, fromPos, itemEx, toPos)
    ...
    if getPlayerStorageValue(cid, t.storage) < os.time() then
       doPlayerPopupFYI(cid, "[ Batalha Diaria ] Parabens ! aqui esta a recompensa da [ 4 ] das [ 12 ] Batalhas Diarias!")	   	   
