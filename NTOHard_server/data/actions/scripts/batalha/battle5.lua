local t = {
storage = 676635,  -- storage, so mude se tiver usando pra outra coisa.
...
function onUse(cid, item, fromPos, itemEx, toPos)
    ...
    if getPlayerStorageValue(cid, t.storage) < os.time() then
       doPlayerPopupFYI(cid, "[ Batalha Diaria ] Parabens ! aqui esta a recompensa da [ 5 ] das [ 12 ] Batalhas Diarias!")	   	   
