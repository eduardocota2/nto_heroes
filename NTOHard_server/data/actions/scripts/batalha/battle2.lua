local t = {
storage = 676632,  -- storage, so mude se tiver usando pra outra coisa.
...
function onUse(cid, item, fromPos, itemEx, toPos)
    ...
    if getPlayerStorageValue(cid, t.storage) < os.time() then
       doPlayerPopupFYI(cid, "[ Batalha Diaria ] Parabens ! aqui esta a recompensa da [ 2 ] das [ 12 ] Batalhas Diarias!")	   
