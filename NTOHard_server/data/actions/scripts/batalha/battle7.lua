local t = {
storage = 676637,  -- storage, so mude se tiver usando pra outra coisa.
...
function onUse(cid, item, fromPos, itemEx, toPos)
    ...
    if getPlayerStorageValue(cid, t.storage) < os.time() then
       doPlayerPopupFYI(cid, "[ Batalha Diaria ] Parabens ! aqui esta a recompensa da [ 7 ] das [ 12 ] Batalhas Diarias!")	   	   
	   doPlayerAddExp(cid, 29000)	   
	   doPlayerAddItem(cid, 2152, 16)
