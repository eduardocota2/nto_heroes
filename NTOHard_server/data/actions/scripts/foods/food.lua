local FOODS, MAX_FOOD = {
	...
	[2672] = {720, "Chomp."}, [2673] = {60, "Yum."}, [2674] = {720, "Yum."}, [2675] = {156, "Yum."},
	...
	[8840] = {400, "Yum."}, [8841] = {12, "Urgh."}, [8842] = {84, "Munch."}, [8843] = {60, "Crunch."},
	...
	[12639] = {18, "Munch."},
	-- Vendidos \/
	[2691] = {335, "Crunch."}, [2671] = {720, "Chomp."}, [2674] = {335, "Yum."},[8840] = {720, "Yum."},
	[2666] = {720, "Munch."},[2684] = {720, "Chomp."}
...
function onUse(cid, item, fromPosition, itemEx, toPosition)
	...
	if(getPlayerFood(cid) + size > MAX_FOOD) then
		doPlayerSendCancel(cid, "Você está sem fome.")
		return true
	end
