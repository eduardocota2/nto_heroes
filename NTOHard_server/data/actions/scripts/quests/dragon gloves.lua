...
if getPlayerStorageValue(cid, 11814) < 1 then
local bag = doPlayerAddItem(cid, 1987, 1)
doAddContainerItem(bag, 134, 1)
doPlayerAddExp(cid, 175000)
doPlayerSendTextMessage(cid, 22, "Parabéns, você encontrou uma Dragon Gloves !")
doSendMagicEffect(position1, 186)
setPlayerStorageValue(cid, 11814, 1)
