...
if getPlayerStorageValue(cid, 11815) < 1 then
local bag = doPlayerAddItem(cid, 1987, 1)
doAddContainerItem(bag, 2645, 1)
doPlayerAddExp(cid, 15000)
doPlayerSendTextMessage(cid, 22, "Parabéns, você encontrou uma Plate Gloves !")
doSendMagicEffect(position1, 186)
setPlayerStorageValue(cid, 11815, 1)
