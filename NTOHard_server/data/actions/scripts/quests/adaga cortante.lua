...
if getPlayerStorageValue(cid, 11816) < 1 then
local bag = doPlayerAddItem(cid, 1987, 1)
doAddContainerItem(bag, 131, 1)
doPlayerAddExp(cid, 15000)
doPlayerSendTextMessage(cid, 22, "Parabéns, você encontrou uma Adaga Cortante !")
doSendMagicEffect(position1, 186)
setPlayerStorageValue(cid, 11816, 1)
