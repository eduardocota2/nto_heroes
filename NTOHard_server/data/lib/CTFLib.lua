...
CTF_LIB = {
	waitpos = {x = 982, y = 795, z =7}, -- Posição da sala de espera
	tppos = {x = 1022, y = 1020, z =7}, -- Onde o TP vai aparecer
	...
	teams = {
		["Branco"] = {
			temple = 4, -- TownID da equipe vermelha
			outfit = {lookType = 147,lookHead = 0, lookBody = 132, lookLegs = 113, lookFeet = 94},

			flag = {
				id = 9496,
				flag_pos = {x = 1022, y = 766, z =7}, -- Posição onde a bandeira vermelha vai ser criada
				gnd_pos = {x = 1022, y = 759, z =7}, -- Onde os players da equipe vermelha entregarão a bandeira.
			},
		},

		["Preto"] = {
			temple = 3, -- TownID da equipe verde
			outfit = {lookType = 148,lookHead = 0, lookBody = 132, lookLegs = 113, lookFeet = 94},

			flag = {
				id = 9497,
				flag_pos = {x = 948, y = 766, z =7}, -- Posição onde a bandeira verde vai ser criada
				gnd_pos = {x = 948, y = 773, z =7}, -- Onde os players da equipe verde entregarão a bandeira.
			},
		},
	},
}
...
local function Alert(uid)
	if (isCreature(uid)) then
		...
		doSendAnimatedText(getThingPos(uid), "PEGUEI HAHA", math.random(50, 200))
