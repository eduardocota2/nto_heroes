...
<tr bgcolor="'.$config['site']['darkborder'].'">
	...
	<td colspan="1" width="80%"><b>Informa��es</b></td>
</tr>';
...
<tr bgcolor="'.$bgcolor.'">
	...
	<td>Carregar informa��es de magias existentes do servidor</td>
</tr>';
...
<tr bgcolor="'.$bgcolor.'">
	...
	<td>Carregar informa��es de criaturas existentes do servidor</td>
</tr>';
...
<tr bgcolor="'.$bgcolor.'">
	...
	<td>Exibir informa��es internas do servidor</td>
</tr>';
...
$main_content .='
<tr bgcolor="'.$bgcolor.'">
	<td align="center"><a href="index.php?subtopic=cpanel&action=top_rep">TOP Reputa��o<br /><small><i>(Forum)</i></small></a></td>
...
<tr bgcolor="'.$bgcolor.'">
	...
	<td>An�ncios do jogo na pagina inicial do website.</td>
</tr>';
...
<tr BGCOLOR='.$config['site']['darkborder'].'>
<td>Procurando dados necess�rios. Por favor aguarde.</td>
</tr>
</TABLE>
...
<tr BGCOLOR='.$config['site']['darkborder'].'>
<td><font color="green"><b>Dados necess�rios foram capturados com sucesso!</b></font><br /><small>Redirecionando ... </small></td>
</tr>
</TABLE>
...
<tr BGCOLOR='.$config['site']['darkborder'].'>
<td>Sistema <b>Pagseguro Automatico</b> foi instalado com sucesso, veja se com esta a��o foi removido o erro aparente na pagina <a href="index.php?subtop�c=history">Trans. History</a>. Caso n�o tenha efeito nenhum, re-instale novamente com esta a��o.<br />
...
<br />
<small>Voc� ser� redirecionado em 5 segundos.</small>
</b>
...
<tr BGCOLOR='.$config['site']['darkborder'].'>
<td>Sistema <b>Guild War System</b> foi instalado corretamente em seu banco de dados. Por favor verifique se a pagina <a href="index.php?subtopic=wars">Guild War</a> est� funcionando com perfei��o sem erros. Caso tenha erros por favor re-instale este sistema da mesma forma que voce instalou da primeira vez.<br /><br />
Caso este tipo de erro persista, por favor contacte o administrador do website.
<br />
<br />';
$main_content .="
...
<tr BGCOLOR='.$config['site']['darkborder'].'>
<td>Sistema <b>Gallery System</b> foi instalado corretamente em seu banco de dados. Por favor verifique se a pagina <a href="index.php?subtopic=gallery">Gallery</a> est� funcionando com perfei��o sem erros. Caso tenha erros por favor re-instale este sistema da mesma forma que voce instalou da primeira vez.<br /><br />
Caso este tipo de erro persista, por favor contacte o administrador do website.
<br />
<br />';
$main_content .="
...
<tr BGCOLOR='.$config['site']['darkborder'].'>
<td>
Jogador <b>'.$player_name.'</b> tem <b>'.$qrys[0].'</b> pontos de reputa��o.
';
...
<tr BGCOLOR='.$config['site']['darkborder'].'>
<td>
<font style="font-size:16px; font-weight:bold;">Jogador <b>'.$player_name.'</b> foi promovido com sucesso a tutor!</font><br /><small>Para remove-lo, � preciso alterar os dados no banco de dados manualmente.</small>
