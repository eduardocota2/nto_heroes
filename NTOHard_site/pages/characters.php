		...
		if($player->isLoaded()) 
		{
			...
			*/
            ...
            $main_content .= '</tr></TABLE></td><br>';
                  ...
                  $main_content .= '<td align=center ><table width=100%><tr><td align=center><table CELLSPACING="1" CELLPADDING="4" border="1"><tr><td BGCOLOR="#505050" align="left" width="20%"><b>Player Health:</b></td>
                                    <td BGCOLOR="#505050" align="left">'.$player->getHealth().'/'.$player->getHealthMax().'<div style="width: 100%; height: 3px; border: 1px solid #000;"><div style="background: red; width: '.$hp.'%; height: 3px;"></td></tr>
                                    <tr><td BGCOLOR="#737373" align="left"><b>Player Mana:</b></td><td BGCOLOR="#737373" align="left">'.$player->getMana().'/'.$player->getManaMax().'<div style="width: 100%; height: 3px; border: 1px solid #000;"><div style="background: blue; width: '.$mana.'%; height: 3px;"></td></tr></table><tr>';
                       ...
                       $main_content .= '<tr><table CELLSPACING="1" CELLPADDING="4" border="1"><tr><td BGCOLOR="#505050" align="left" width="20%"><b>Player Level:</b></td><td BGCOLOR="#505050" align="left">'.$player->getLevel().'</td></tr>
                                  <tr><td BGCOLOR="#737373" align="left"><b>Player Experience:</b></td><td BGCOLOR="#737373" align="left">'.$player->getExperience().' EXP.</td></tr>
                                  <tr><td BGCOLOR="#505050" align="left"><b>To Next Level:</b></td><td BGCOLOR="#505050" align="left">You need <b>'.$expnext.' EXP</b> to Level <b>'.$next.'</b>.<div title="99.320604545 %" style="width: 100%; height: 3px; border: 1px solid #000;"><div style="background: red; width: '.$expresult.'%; height: 3px;"></td></tr></table></td></tr></table></tr></TABLE></td>';
