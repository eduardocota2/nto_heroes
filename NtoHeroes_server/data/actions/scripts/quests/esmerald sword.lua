...
if getPlayerStorageValue(cid, 17329) < 1 then
local bag = doPlayerAddItem(cid, 1987, 1)
doAddContainerItem(bag, 2441, 1)
doPlayerAddExp(cid, 75000)
doPlayerSendTextMessage(cid, 22, "Parabéns, você encontrou uma Esmerald Sword!")
doSendMagicEffect(position1, 186)
setPlayerStorageValue(cid, 17329, 1)
