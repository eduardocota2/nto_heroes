...
local health = 1750 -- A cada 1 segundo quantos aumentar de vida
...
if getPlayerStorageValue(cid, 19733) ~= 1 or getCreatureCondition(cid, CONDITION_REGENERATION, 1) == false then
    ...
    setPlayerStorageValue(cid, 19733,1) -- storage verifica transformado, quando = 1 player esta transformado.
