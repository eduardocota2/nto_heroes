...
function creatureSayCallback(cid, type, msg)
	...
	selfSay('Vá até o prédio do Hokage Naruto- em Konoha, em algum armario você encontrará a solução secreta, você já sabe oque tem que fazer !{entregar}', cid)
	...
	selfSay('Você precisa de level 20 ou mais para realizar essa missão.', cid)
	end
	talkState[talkUser] = 0
