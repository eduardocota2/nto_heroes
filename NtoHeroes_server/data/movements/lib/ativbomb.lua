...
mindmg = 10000, -- dmg minimo que tira (nao é necessariamente o dano que vai sair do cara pois precisa desconsiderar as defesas dele antes)
maxdmg = 20000, -- dmg maximo que tira (nao é o dano que vai sair do cara)
